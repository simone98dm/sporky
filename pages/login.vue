    ...
    <div class="max-w-md w-full">
      ...
      >
        ...
        <div class="text-center mb-8">
          <!-- Logo -->
          <div
            class="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-r from-green-400 to-blue-500 rounded-2xl mb-6"
          >
            <svg
        ...
        <div
          v-if="errorMessage"
          class="mb-6 p-4 bg-red-500/20 border border-red-400/30 rounded-xl"
        >
        ...
        <div v-if="$route.query.error" class="mb-6">
          ...
          >
            <div
              class="flex items-center justify-center w-10 h-10 bg-red-500/20 rounded-full mx-auto mb-3"
            >
              <svg
              ...
              >
                <path
                  ...
                  stroke-linejoin="round"
                  stroke-width="2"
                  d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-2.5L13.732 4c-.77-.833-1.732-.833-2.502 0L3.732 16.5C2.962 17.333 3.924 19 5.464 19z"
                />
              </svg>
            </div>
        ...
        >
          ...
          <div
            class="absolute inset-0 bg-gradient-to-r from-green-600 to-green-700 rounded-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300"
          ></div>
        </button>

        <!-- Privacy Note -->
        <p class="text-xs text-gray-400 text-center mt-6 leading-relaxed">
          By continuing, you agree to connect your Spotify account. We only
          access your top tracks data and don't store any personal information.
        </p>
      </div>
      <!-- Additional Info -->
