  ...
  <div class="min-h-screen py-8 px-6">
    <div class="max-w-6xl mx-auto">
      ...
      <div class="text-center mb-12">
        <div
          class="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-r from-green-400 to-blue-500 rounded-2xl mb-6"
        >
          <svg
        ...
        <p class="text-xl text-gray-300 max-w-2xl mx-auto">
          Discover your most listened-to songs and explore your musical journey
      ...
      <!-- Control Panel -->
      <div
        class="bg-white/10 backdrop-blur-lg rounded-3xl p-8 mb-12 border border-white/20"
      >
        <div
            ...
            <div class="space-y-6">
              ...
              <div class="grid grid-cols-1 gap-4">
                ...
                <StatsCard
                  ...
                  color="blue"
                  :progress="
                    uniqueArtistsCount / Math.max(currentTracks.length, 1)
                  "
                />
      ...
      <div v-else-if="!isLoading && !hasError" class="text-center py-16">
        ...
        <p class="text-gray-400 max-w-md mx-auto">
          We couldn't find any tracks for this time period. Try selecting a
          different time range or listen to more music on Spotify!
        </p>
      </div>
    </div>
  </div>
