  ...
  >
    <div class="flex items-center justify-between mb-6">
      <h3 class="text-xl font-bold text-white flex items-center gap-2">
        <div
          class="w-6 h-6 bg-gradient-to-r from-green-400 to-blue-500 rounded-lg flex items-center justify-center"
        >
          <svg
    ...
    <div v-else class="space-y-4">
      ...
      <div class="space-y-3">
        ...
        <div class="flex flex-wrap gap-2">
          ...
          >
            ...
            <span class="ml-2 text-xs text-green-300"
      ...
      <div class="pt-4 border-t border-white/10">
        <h4
          class="text-sm font-semibold text-gray-300 uppercase tracking-wide mb-3"
        >
          Your Music Profile
        </h4>
...
const genreTags = computed(() => {
  ...
  const genresArray = Array.from(genreCounts.entries()).map(
    ([name, count]) => ({
      name,
      count,
